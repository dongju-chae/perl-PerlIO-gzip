# This Makefile is for the PerlIO::gzip extension to perl.
#
...
#     ABSTRACT_FROM => q[gzip.pm]
#     AUTHOR => [q[Nicholas Clark <nwc10+perlio-gzip@colon.colondot.net>]]
#     BUILD_REQUIRES => {  }
#     CONFIGURE_REQUIRES => {  }
#     DEFINE => q[]
#     LIBS => [q[-lz]]
...
INST_LIBDIR      = $(INST_LIB)/PerlIO
INST_ARCHLIBDIR  = $(INST_ARCHLIB)/PerlIO
...
DISTNAME = PerlIO-gzip
DISTVNAME = PerlIO-gzip-0.20
...
# PerlIO::gzip might depend on some other libraries:
...
manifypods : pure_all  \
	...
	$(NOECHO) $(POD2MAN) --section=$(MAN3EXT) --perm_rw=$(PERM_RW) -u \
	  gzip.pm $(INST_MAN3DIR)/PerlIO::gzip.$(MAN3EXT) 
...
clean :: clean_subdirs
	- $(RM_F) \
	  ...
	  *perl.core MYMETA.json \
	  ...
	  core.[0-9][0-9][0-9][0-9][0-9] gzip.c \
...
metafile : create_distdir
	...
	$(NOECHO) $(ECHO) 'abstract: '\''Perl extension to provide a PerlIO layer to gzip/gunzip'\''' >> META_new.yml
	$(NOECHO) $(ECHO) 'author:' >> META_new.yml
	$(NOECHO) $(ECHO) '  - '\''Nicholas Clark <nwc10+perlio-gzip@colon.colondot.net>'\''' >> META_new.yml
	...
	$(NOECHO) $(ECHO) 'name: PerlIO-gzip' >> META_new.yml
	...
	$(NOECHO) $(ECHO) '   "abstract" : "Perl extension to provide a PerlIO layer to gzip/gunzip",' >> META_new.json
	$(NOECHO) $(ECHO) '   "author" : [' >> META_new.json
	$(NOECHO) $(ECHO) '      "Nicholas Clark <nwc10+perlio-gzip@colon.colondot.net>"' >> META_new.json
	$(NOECHO) $(ECHO) '   ],' >> META_new.json
	...
	$(NOECHO) $(ECHO) '   },' >> META_new.json
	$(NOECHO) $(ECHO) '   "name" : "PerlIO-gzip",' >> META_new.json
...
ppd :
	...
	$(NOECHO) $(ECHO) '    <ABSTRACT>Perl extension to provide a PerlIO layer to gzip/gunzip</ABSTRACT>' >> $(DISTNAME).ppd
	$(NOECHO) $(ECHO) '    <AUTHOR>Nicholas Clark &lt;nwc10+perlio-gzip@colon.colondot.net&gt;</AUTHOR>' >> $(DISTNAME).ppd
...
pm_to_blib : $(FIRST_MAKEFILE) $(TO_INST_PM)
	$(NOECHO) $(ABSPERLRUN) -MExtUtils::Install -e 'pm_to_blib({@ARGV}, '\''$(INST_LIB)/auto'\'', q[$(PM_FILTER)], '\''$(PERM_DIR)'\'')' -- \
	  gzip.pm $(INST_LIB)/PerlIO/gzip.pm 
